...
<div class="">
    <div class="">
        <div class=""><h4 class="d-inline-block">Category  : {{ $category->title }}</h4></div>
    </div>
    <div class="my-3">
        <form action="{{ route("page.category",$category->slug ) }}" method="get">
        ...
        @if(request('keyword'))
            <div class="mb-3">
                ...
                <span><a href="{{ route("page.category",$category->slug) }}"><i class="bi bi-repeat"></i></a></span>
            </div>
        @endif
        @isset($category)
